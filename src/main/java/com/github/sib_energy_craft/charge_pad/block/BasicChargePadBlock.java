 ...
 * @author sibmaks
 */
public class BasicChargePadBlock extends AbstractChargePadBlock {
    @Getter
    private final String containerNameCode;

    public BasicChargePadBlock(@NotNull Settings settings,
    ...
    public BlockEntity createBlockEntity(@NotNull BlockPos pos,
        ...
        return new BasicChargePadBlockEntity(pos, state, this);
    }
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(@NotNull World world,
        ...
        return checkPadType(world, type, Entities.BASIC_CHARGE_PAD);
    }
}
